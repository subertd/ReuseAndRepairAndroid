...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_ORGANIZATION_REPAIR_ITEM_COL_ORGANIZATION_ID = "organization_id";
    public static final String TABLE_ORGANIZATION_REPAIR_ITEM_COL_ITEM_ID = "item_id";
    public static final String TABLE_ORGANIZATION_REPAIR_COL_ADDITIONAL_REPAIR_INFO = "additional_repair_info";
    //
